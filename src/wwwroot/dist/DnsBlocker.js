...
async function handleDeviceButton(device, index, action) {
    if (action === "enable") {
        device.enableBlocking = !device.enableBlocking;
        const newState = { enabled: device.enableBlocking };
...
async function handleFilterButton(filter, index, action) {
    if (action === "enable") {
        filter.enableBlocking = !filter.enableBlocking;
        const newState = { enabled: filter.enableBlocking };
